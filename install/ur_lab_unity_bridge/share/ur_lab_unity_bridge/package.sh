...
_colcon_package_sh_COLCON_CURRENT_PREFIX="/mnt/c/Users/Amir/Downloads/ros2_ws/install/ur_lab_unity_bridge"
...
# source sh hooks
_colcon_package_sh_source_script "$COLCON_CURRENT_PREFIX/share/ur_lab_unity_bridge/hook/path.sh"
